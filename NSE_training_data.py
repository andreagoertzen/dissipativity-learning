#########
# code from: https://github.com/raj-brown/fourier_neural_operator/blob/master/data_generation/ns_2d.py
#########
...
for j in range(N//bsize):
    ...
    #Solve NS
    sol, sol_t = navier_stokes_2d(w0, f, 1e-3, 500.0, 1e-4, record_steps)
...
scipy.io.savemat('training/ns_data_visc1e-3.mat', mdict={'a': a.cpu().numpy(), 'u': u.cpu().numpy(), 't': sol_t.cpu().numpy()})