...
import torch
from random_fields import GaussianRF, GaussianRF2d
from kolmogorov_flow import KolmogorovFlow2d
from periodic import NavierStokes2d
...
def legacy_solver(args):
    ...
    NS.advance(T_in, delta_t=delta_t)
